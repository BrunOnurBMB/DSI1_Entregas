...
public class TelaCadastro extends JFrame{
	...
	//Validações de usuario e cadastro
	...
	public TelaCadastro() {
		...
		tela.add(lblIdentificacao); // <- adiciona o label ao panel
		...
		btnCadastrar.addActionListener((ActionEvent e) -> {
			try {
				...
				if ("".equals(usu.getNome())) {
					...
					//Verificando se somente o usuario consta no banco, neste caso faremos uma sobrecarga de método
					...
					if (usuarioValido == true) {
						...
						if (cadastroValido == true) {
							//Usuário cadastrado na base de dados com sucesso
